...
class _CadastroScreenState extends State<CadastroScreen> {
  ...
  Future<void> _cadastrar() async {
    ...
    final erro = await context.read<AccountService>().registrarPublico(
      ...
      children: [
        ...
        Container(
          ...
          child: const Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'Informe seu e-mail. Enviaremos uma senha temporária para você acessar o aplicativo.',
        ...
        if (_erro.isNotEmpty) ...[
          ...
          Container(
            ...
            child: Text(
              _erro,
              style: const TextStyle(color: AppColors.deleteFg, fontSize: 13),
            ),
          ),
        ],
        const SizedBox(height: 24),
